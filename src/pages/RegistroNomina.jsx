...
export default function RegistroNomina() {
  ...
  const descuentos = desSalud + desPension + parseFloat(deducciones);
    ...
    <Layout>
      <div className="max-w-xl mx-auto mt-10 bg-white p-6 shadow rounded">
        ...
        <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
          ...
          <div>
            <label className="block mb-1 font-semibold">Otros descuentos</label>
            <input
              type="number"
          ...
          <div className="bg-gray-100 p-3 rounded text-sm">
            <p>
              <strong>Salario base mensual:</strong> $
              {salarioBase.toLocaleString()}
            </p>
            <p>
              <strong>Auxilio de transporte mensual:</strong> $
              {auxTransporte.toLocaleString()}
            </p>
            <div className="mb-3 border-b border-gray-300"></div>

            <p>
              <strong>Salario Dias:</strong> ${salarioDias.toLocaleString()}
            </p>
            <p>
              <strong>Auxilio de transporte Dias:</strong> $
              {auxDias.toLocaleString()}
            </p>
            <div className="mb-3 border-b border-gray-300"></div>

            <p>
              <strong>Descuento de salud </strong> ${desSalud.toLocaleString()}
            </p>
            <p>
              <strong>Descuento de pension </strong> $
          ...
          <button type="submit" className="bg-green-600 text-white w-full p-2">
            Registrar Nómina
          </button>
        </form>
      </div>
